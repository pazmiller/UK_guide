...
export const nottinghamData: CityData = {
  ...
  restaurants: [
    ...
    {
      id: 'no-r8',
      slug: 'red-dog-saloon-nottingham',
      name: 'Red Dog Saloon Nottingham',
      cuisine: 'American',
      shortDescription: '美式烤肉与汉堡',
      description: '主打美式烤肉，各种酒很多。汉堡很大一个，一个人一个就饱了。最近量变小了些，饭量大的话想要纯吃烤肉吃饱的话两人人均大概40到50左右，会收服务费，但是尝鲜还是可以的。',
      recommendReason: '主打美式烤肉，各种酒很多。不过汉堡很大一个，一个人一个就饱了。',
      address: '20-22 Victoria Street, Nottingham NG1 2EX',
      priceRange: '£20-40',
      website: 'https://www.reddogsaloon.co.uk/',
      images: [],
      mustTry: [],
    },
    {
