...
export const londonRestaurants: Restaurant[] = [
  ...
  },
  {
    ...
    description: '装修非常有韵味，极其受本地人欢迎，服务很好，菜式正宗且精致，价格也稍贵。有更好吃还更便宜的意大利菜，但整体体验没有 Gloria 好。菜的种类其实不算多。很多人推荐它的玛格利特鸡尾酒，不过暂无人试过。',
    priceRange: '~£40/人',
    images: ['/gloria.jpg'],
  ...
  {
    id: 'lon-r30',
    slug: 'amalfi-ristorante-argyll-stree',
    name: 'Amalfi Ristorante - Argyll Stree',
    cuisine: 'Italian',
  ...
  },
  {
    ...
    description: '精致却不失传统，分量较少。俄罗斯菜在伦敦不算多，这家算是很不错的选择。',
    priceRange: '£30+/人',
    images: ['/ZIMA.jpg'],
