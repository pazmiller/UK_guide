...
import { Menu, X, MapPin, Building, Utensils, Coffee, ChevronDown } from 'lucide-react';
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link
              ...
              className={`font-medium transition-colors relative group ${
                pathname === '/' ? 'text-[#F4A261]' : 'text-white/90 hover:text-[#F4A261]'
              }`}
            >
              Home
            ...
            >
              <Link
                ...
                className={`flex items-center gap-1 font-medium transition-colors relative group ${
                  isOnLondon ? 'text-[#F4A261]' : 'text-white/90 hover:text-[#F4A261]'
                }`}
              >
                London
                  ...
                  <div className="bg-white rounded-xl shadow-xl overflow-hidden min-w-[180px]">
                    {londonSubLinks.map((sub) => (
                      <Link
                        key={sub.href}
                        href={sub.href}
                        className={`flex items-center gap-3 px-5 py-3 text-sm font-medium transition-colors hover:bg-[#F1FAEE] ${
                          pathname === sub.href ? 'text-[#E63946] bg-[#F1FAEE]' : 'text-[#1D3557]'
                        }`}
                      >
            ...
            >
              <Link
                href="/othercities"
                className={`flex items-center gap-1 font-medium transition-colors relative group ${
                  isOnCities ? 'text-[#F4A261]' : 'text-white/90 hover:text-[#F4A261]'
                }`}
              >
                Other Cities
                  ...
                  <div className="bg-white rounded-xl shadow-xl overflow-hidden min-w-[180px]">
                    {citiesSubLinks.map((sub) => (
                      <Link
                        key={sub.href}
                        href={sub.href}
                        className={`block px-5 py-3 text-sm font-medium transition-colors hover:bg-[#F1FAEE] ${
                          pathname === sub.href ? 'text-[#E63946] bg-[#F1FAEE]' : 'text-[#1D3557]'
                        }`}
                      >
                        {sub.label}
            ...
            >
              <Link
                href="/europa"
                className={`flex items-center gap-1 font-medium transition-colors relative group ${
                  isOnEuropa ? 'text-[#F4A261]' : 'text-white/90 hover:text-[#F4A261]'
                }`}
              >
                Europa
            ...
            <Link
              href="/contact"
              className={`font-medium transition-colors relative group ${
                pathname === '/contact' ? 'text-[#F4A261]' : 'text-white/90 hover:text-[#F4A261]'
              }`}
            >
              Contact
            ...
            <Link
              href="/about"
              className={`font-medium transition-colors relative group ${
                pathname === '/about' ? 'text-[#F4A261]' : 'text-white/90 hover:text-[#F4A261]'
              }`}
            >
              About
